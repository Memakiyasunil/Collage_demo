  ...
  return (
    <div className="fixed top-0 inset-x-0 z-[100] flex justify-center p-4 pointer-events-none">
      <motion.nav
        ...
        className="pointer-events-auto bg-slate-950/70 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] rounded-full px-6 py-2.5 flex items-center justify-between w-full max-w-7xl relative"
      >
