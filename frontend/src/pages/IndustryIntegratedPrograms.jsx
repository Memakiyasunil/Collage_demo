...
const IndustryIntegratedPrograms = () => {
  return (
    <div className="min-h-screen bg-slate-950 font-sans flex flex-col justify-center items-center pt-32 pb-24 px-8 text-center text-white relative overflow-hidden">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tight">Industry Integrated Programs</h1>
        <p className="text-xl text-slate-300 font-light leading-relaxed mb-8">
          This page is currently under construction. Details about our industry-aligned programs will be available here soon.
        </p>
...
export default IndustryIntegratedPrograms;
