...
import { slideInLeft, slideInRight, floatAnimation, pulseAnimation } from '../utils/animations';
...
const BrushCircle = ({ text }) => (
  ...
  >
    ...
    <motion.div 
      ...
      className="absolute inset-3 bg-gradient-to-br from-orange-600 via-orange-500 to-yellow-500 rounded-full shadow-[0_0_40px_rgba(249,115,22,0.5)]" 
...
const Vision = () => {
  return (
    <div className="min-h-screen bg-[#0b1120] font-sans relative overflow-hidden pb-32">
      ...
      <div className="absolute top-24 left-10 md:left-20 text-[8rem] md:text-[14rem] font-bold text-white/[0.02] select-none pointer-events-none tracking-tighter leading-none z-0 mix-blend-overlay">
        Vision
      </div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[8rem] md:text-[14rem] font-bold text-white/[0.02] select-none pointer-events-none tracking-tighter leading-none z-0 mix-blend-overlay">
        Mission
      </div>
      <div className="absolute bottom-20 right-10 text-[8rem] md:text-[14rem] font-bold text-white/[0.02] select-none pointer-events-none tracking-tighter leading-none z-0 mix-blend-overlay">
        Values
      </div>

      {/* Blurred Colored Background Circles */}
      <div className="absolute top-10 -left-40 w-[40rem] h-[40rem] bg-emerald-900/20 blur-[120px] rounded-full pointer-events-none z-0" />
      <div className="absolute bottom-10 -right-20 w-[45rem] h-[45rem] bg-indigo-900/10 blur-[120px] rounded-full pointer-events-none z-0" />
      <div className="absolute top-1/2 left-1/4 w-[30rem] h-[30rem] bg-amber-900/10 blur-[100px] rounded-full pointer-events-none z-0" />
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:24px_24px]"></div>
      
      {/* --- MAIN CONTENT --- */}
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 pt-40 flex flex-col gap-32">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20 group">
          ...
          >
            <div className="relative bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 p-10 md:p-12 rounded-[2rem] shadow-[0_20px_40px_rgba(0,0,0,0.3)] w-full max-w-xl transition-all duration-500 hover:-translate-y-2 hover:border-amber-500/30">
              <div className="absolute -top-6 -left-6 w-16 h-16 bg-amber-500 rounded-2xl rotate-12 flex items-center justify-center shadow-lg">
                <span className="text-white text-3xl">👁️</span>
              </div>
              <h3 className="text-4xl font-extrabold text-white mb-6 border-b border-slate-700 pb-4">Our Vision</h3>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20 group">
          ...
          <motion.div 
            ...
            initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideInRight}
          >
            <div className="relative bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 p-10 md:p-12 rounded-[2rem] shadow-[0_20px_40px_rgba(0,0,0,0.3)] w-full max-w-xl transition-all duration-500 hover:-translate-y-2 hover:border-orange-500/30">
              ...
              <h3 className="text-4xl font-extrabold text-white mb-6 border-b border-slate-700 pb-4">Our Mission</h3>
              <p className="text-slate-400 text-[1.05rem] leading-relaxed font-medium">
