...
export const SiteProvider = ({ children }) => {
  const [footerData, setFooterData] = useState({
    description: 'Edufordge is a Section-8 non-profit organization committed to transforming IT education through industry-aligned programs and cutting-edge specializations.',
